        ...
        <div class=" py-24 sm:py-32">
            <div class="mx-auto px-6 lg:px-8">
                <div class="mx-auto lg:text-center" data-anim="fade-in">
                    ...
                    <p
                        class="mt-2 text-3xl font-bold tracking-tight text-light sm:text-4xl"
                    >
                ...
                <div
                    class="mx-auto mt-16 sm:mt-20 lg:mt-24 lg:max-w-4xl"
                >
                    <dl
                    ...
                    >
                        <div class="relative pl-16" data-anim="fade-in slide-right">
                            ...
                            <dd class="mt-2 text-base leading-7 text-muted">
                                Morbi viverra dui mi arcu sed. Tellus semper
                                adipiscing suspendisse semper morbi. Odio urna
                                massa nunc massa.
                            </dd>
                        </div>
                        <div class="relative pl-16" data-anim="fade-in slide-left">
                            ...
                            <dd class="mt-2 text-base leading-7 text-muted">
                                ...
                                ultricies libero dolor eget. Sem sodales gravida
                        ...
                        <div class="relative pl-16" data-anim="fade-in slide-right">
                            ...
                            <dd class="mt-2 text-base leading-7 text-muted">
                                Quisque est vel vulputate cursus. Risus proin
                                diam nunc commodo. Lobortis auctor congue
                                commodo diam neque.
                            </dd>
                        </div>
                        <div class="relative pl-16" data-anim="fade-in slide-left">
                            ...
                            <dd class="mt-2 text-base leading-7 text-muted">
                                ...
                                Tincidunt mattis aliquet hac quis. Id hac
