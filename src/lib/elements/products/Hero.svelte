    ...
    <div class="container">
        ...
        <div class="relative overflow-hidden">
            <div class="relative z-10">
                <div
                    class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-10 lg:py-40"
                >
                    <div class="max-w-2xl text-center mx-auto">
                        ...
                        >
                            <p class="text-lg text-muted">
                                At DataTech, we specialize in developing,
                                manufacturing, and delivering high-quality
                                electrical and electronic cables and connectors.
                                Our products are trusted across diverse
                                industries, including mechanical engineering,
                                factory automation, data processing, networking,
